...
#define REGISTERING_NETWORK "Joining Network..."
#define CONNECT_SERVER "Connecting Cloud..."
...
#define FREE_TALK "Free Chat"
#define ENTERING_WIFI_CONFIG_MODE "Wifi Config Mode..."
